        ...
        <div className="bg-gradient-to-r from-orange-500 via-red-500 to-purple-700">
            <header className="container mx-auto px-6 py-4 flex justify-between items-center text-white relative">
                ...
                <nav className="hidden lg:flex items-center">
                    ...
                    <Link href="/cart">
                        <div className="relative inline-flex items-center justify-center p-2 bg-transparent hover:bg-orange-500 rounded-full cursor-pointer transition-all duration-300">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-white hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                            ...
                            <span className="absolute top-0 right-0 inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-red-600 rounded-full">3</span>
                        </div>
                    </Link>
